...
if __name__ == "__main__":
    eleccion = int(input ("Por favor selecciona '1' si quieres ingresar uns secuenia escrita o '0' si quieres ingresar un formato fasta"))
    if eleccion : 
        seq = input ("Por favor ingresa la secuencias que quieres analizar")
        assert (validate_dna_sequence(seq))== True
    else: 
        validacion = validate_fasta_format